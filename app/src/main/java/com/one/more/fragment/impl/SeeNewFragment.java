...
import com.one.more.presenter.impl.NewsPrensenterImpl;
import com.one.more.ui.adapter.NewsAdapter;

/**
 * Created by mcz on 2016/10/19
 */

public class SeeNewFragment extends BaseFragment implements INewsFragment {;
    // 标志位，标志已经初始化完成。
