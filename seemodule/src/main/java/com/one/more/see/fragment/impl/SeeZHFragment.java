...
import com.one.more.see.presenter.impl.ZHPresenterImpl;
import com.one.more.see.ui.adapter.ZhihuAdapter;
...
public class SeeZHFragment extends BaseFragment<IZHFragment,IZHPresenter<IZHFragment>> implements IZHFragment {;
    // 标志位，标志已经初始化完成。
    ...
    @Nullable
    @Override
    public IZHPresenter<IZHFragment> createPresenter() {
